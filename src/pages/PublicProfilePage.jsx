...
// Stats Bar Component (uses mock data for now)
const StatsBar = ({ profile }) => {
  // Mock data - will use real data when available from backend
  const questionsAnswered = profile.questions_answered || 0;
  const avgResponseTime = profile.avg_response_time || profile.sla_hours;
  const satisfactionRate = profile.satisfaction_rate || 98;

  return (
    <div className="grid grid-cols-3 gap-3 p-4 bg-gradient-to-br from-gray-50 to-indigo-50/30 rounded-xl border border-gray-200 shadow-sm">
      <div className="text-center">
        <div className="text-2xl font-bold text-gray-900">{questionsAnswered > 0 ? questionsAnswered : '—'}</div>
        <div className="text-xs text-gray-600 mt-0.5">Answers</div>
      </div>
      <div className="text-center border-x border-gray-300">
        <div className="text-2xl font-bold text-gray-900">{avgResponseTime}h</div>
        <div className="text-xs text-gray-600 mt-0.5">Response</div>
      </div>
      <div className="text-center">
...
// Trust Badge Component (mock - shows for everyone)
const TrustBadge = () => {
  return (
      ...
      return (
        <>
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden">
            {/* Enhanced Header Gradient with Pattern */}
            ...
            <div className="p-6 space-y-6 pb-28 md:pb-6">
              {/* Avatar Section with Activity Badge and Social Links */}
              <div className="flex items-start gap-4 -mt-20">
                <div className="relative flex-shrink-0">
                  ...
                  {/* Activity Badge - shows for all experts */}
              ...
              {/* Name, Title, Badge, and Tagline Section */}
              <div>
          ...
          <div className="hidden md:block mt-6">
            <button
              ...
              className="w-full group bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-bold py-4 px-6 rounded-xl text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Ask Your Question
            </button>
          </div>
          ...
          <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/95 backdrop-blur-sm border-t border-gray-200 shadow-2xl z-50 md:hidden">
            <div className="flex items-center gap-3 max-w-md mx-auto">
              <div className="flex-shrink-0">
                <div className="text-xs text-gray-600">Ask {profile.name?.split(' ')[0]}</div>
