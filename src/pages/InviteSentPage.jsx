    ...
    switch (method) {
      ...
      case 'linkedin':
        return {
          ...
          title: 'Ready to Send on LinkedIn!',
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div className="p-8">
              ...
              {/* Different tips based on method */}
              {method === 'email' ? (
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">
                        Your question has been delivered to {expertName}'s inbox. They'll receive a notification and can respond when they're ready.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-amber-900 mb-1">💡 Next Step</p>
                      <p className="text-sm text-amber-700">
                        Make sure to send the message you copied to {expertName}. The sooner they receive it, the faster you'll get your answer!
                      </p>
                    </div>
                  </div>
                </div>
