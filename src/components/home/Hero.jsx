      ...
      <section className="relative pt-20 pb-16 md:pt-40 md:pb-32 text-center">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="mt-10 md:mt-12 mb-8 md:mb-10 max-w-4xl mx-auto">
            ...
            {/* COMPACT CARDS - Reduced padding, icons, spacing */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
              
              {/* CARD 1: AI Information Layer - COMPACT & MUTED */}
              <div className="bg-white/60 backdrop-blur-sm rounded-lg md:rounded-xl border border-gray-200 p-3 md:p-4 transition-all duration-300 hover:shadow-md opacity-85 md:opacity-100">
              ...
              {/* CARD 2: YOUR EXPERTISE - HERO CARD (EMPHASIZED BUT COMPACT) */}
              <div className="relative bg-gradient-to-br from-indigo-600 to-violet-600 rounded-xl md:rounded-2xl border-3 md:border-4 border-indigo-400 p-4 md:p-5 shadow-xl md:shadow-2xl transform scale-[1.03] md:scale-105 -my-3 md:-my-2 z-10">
                
                {/* "YOU ARE HERE" badge - COMPACT */}
                ...
                {/* Value badge - COMPACT */}
                <div className="inline-flex items-center gap-1.5 text-xs text-indigo-900 bg-white px-2.5 py-1 md:py-1.5 rounded-full font-bold shadow-md">
              ...
              {/* CARD 3: Accountability - COMPACT & MUTED */}
              <div className="bg-white/60 backdrop-blur-sm rounded-lg md:rounded-xl border border-gray-200 p-3 md:p-4 transition-all duration-300 hover:shadow-md opacity-85 md:opacity-100">
                {/* Step indicator + Title - COMPACT */}
                <div className="flex items-center gap-2 mb-3">
