    ...
    <AnimatedBackground variant="hero">
      <section className="relative pt-20 pb-16 md:pt-40 md:pb-32 text-center">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          {/* THE EXPERTISE LADDER - COMPLETELY REDESIGNED FOR MOBILE */}
          <div className="mt-12 md:mt-16 mb-10 md:mb-12 max-w-4xl mx-auto">
            ...
            <div className="mb-6 md:mb-8 text-center">
              ...
              <p className="text-sm text-gray-600">Where do you fit in?</p>
            </div>
            ...
            <div className="md:hidden flex justify-between items-center mb-6 px-4 text-xs font-bold">
              <span className="text-gray-400">FOUNDATION</span>
              <svg className="w-12 h-4 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
              <span className="text-violet-600">VALUE</span>
            </div>
            
            {/* EMPHASIS STACK - Vertical on mobile, Grid on desktop */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              
              {/* CARD 1: AI Information Layer - MUTED & SIMPLIFIED */}
              <div className="bg-white/60 backdrop-blur-sm rounded-xl border border-gray-200 p-4 md:p-6 transition-all duration-300 hover:shadow-md opacity-85 md:opacity-100">
                {/* Step indicator + Title combined */}
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center font-black text-lg flex-shrink-0">
                    1
                  </div>
                  <h3 className="font-bold text-gray-900 text-base md:text-lg">Information</h3>
                </div>
                
                {/* Larger icon for visibility */}
                <div className="w-16 h-16 rounded-xl bg-gray-100 text-gray-500 flex items-center justify-center mb-4 mx-auto md:mx-0">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                
                {/* SHORTENED description - 40% less text */}
                <p className="text-sm text-gray-600 leading-snug">
                  AI provides facts and patterns. Great for research.
                </p>
              </div>

              {/* CARD 2: YOUR EXPERTISE - HERO CARD (MASSIVELY EMPHASIZED) */}
              <div className="relative bg-gradient-to-br from-indigo-600 to-violet-600 rounded-2xl border-4 border-indigo-400 p-6 md:p-8 shadow-2xl transform scale-[1.05] md:scale-110 -my-4 md:-my-2 z-10">
                
                {/* "YOU ARE HERE" badge - Ultra prominent */}
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-white text-indigo-600 text-xs md:text-sm font-black px-4 md:px-6 py-2 rounded-full shadow-xl border-4 border-indigo-100 whitespace-nowrap">
                  ← YOU ARE HERE
                </div>
                
                {/* Step indicator + Title combined - WHITE text */}
                <div className="flex items-center gap-3 mb-5 mt-2">
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/20 backdrop-blur text-white flex items-center justify-center font-black text-xl md:text-2xl flex-shrink-0 ring-4 ring-white/30">
                    2
                  </div>
                  <h3 className="font-black text-white text-lg md:text-xl">Your Expertise</h3>
                </div>
                
                {/* LARGE icon with glow - 80px for maximum visibility */}
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-white/20 backdrop-blur text-white flex items-center justify-center mb-5 mx-auto md:mx-0 shadow-2xl ring-4 ring-white/30">
                  <svg className="w-10 h-10 md:w-12 md:h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </div>
                
                {/* WHITE text on gradient - MEDIUM length for emphasis */}
                <p className="text-white text-base md:text-lg font-medium leading-snug mb-4">
                  You understand context, navigate nuance, and apply experience to their unique situation.
                </p>
                
                {/* Value badge - Stands out on white */}
                <div className="inline-flex items-center gap-2 text-xs md:text-sm text-indigo-900 bg-white px-3 py-2 rounded-full font-bold shadow-lg">
                  <svg className="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-13a1 1 0 10-2 0v.092a4.535 4.535 0 00-1.676.662C6.602 6.234 6 7.009 6 8c0 .99.602 1.765 1.324 2.246.48.32 1.054.545 1.676.662v1.941c-.391-.127-.68-.317-.843-.504a1 1 0 10-1.51 1.31c.562.649 1.413 1.076 2.353 1.253V15a1 1 0 102 0v-.092a4.535 4.535 0 001.676-.662C13.398 13.766 14 12.991 14 12c0-.99-.602-1.765-1.324-2.246A4.535 4.535 0 0011 9.092V7.151c.391.127.68.317.843.504a1 1 0 101.511-1.31c-.563-.649-1.413-1.076-2.354-1.253V5z" clipRule="evenodd" />
                  </svg>
                  <span>Gets paid for answers</span>
                </div>
              </div>

              {/* CARD 3: Accountability & Trust - MUTED & SIMPLIFIED */}
              <div className="bg-white/60 backdrop-blur-sm rounded-xl border border-gray-200 p-4 md:p-6 transition-all duration-300 hover:shadow-md opacity-85 md:opacity-100">
                {/* Step indicator + Title combined */}
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-violet-100 text-violet-600 flex items-center justify-center font-black text-lg flex-shrink-0">
                    3
                  </div>
                  <h3 className="font-bold text-gray-900 text-base md:text-lg">Accountability</h3>
                </div>
                
                {/* Larger icon for visibility */}
                <div className="w-16 h-16 rounded-xl bg-violet-100 text-violet-600 flex items-center justify-center mb-4 mx-auto md:mx-0">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Bottom Summary - SIMPLIFIED & CENTERED */}
