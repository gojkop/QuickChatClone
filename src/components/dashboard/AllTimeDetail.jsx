...
const AllTimeDetail = ({ allQuestions = [] }) => {
  const data = useMemo(() => {
    ...
    const milestones = [];
    if (totalEarnings >= 100000) milestones.push({
      label: 'First $1,000',
      icon: (
    ...
    if (totalEarnings >= 500000) milestones.push({
      label: '$5,000 Earned',
      icon: (
        <svg className="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    if (totalEarnings >= 1000000) milestones.push({
      label: '$10,000 Club',
      icon: (
        <svg className="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    if (totalCount >= 50) milestones.push({
      label: '50 Questions',
      icon: (
    ...
    if (totalCount >= 100) milestones.push({
      label: '100 Questions',
      icon: (
