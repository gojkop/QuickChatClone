  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div 
          className="bg-white rounded-xl shadow-2xl max-w-sm w-full max-h-[90vh] flex flex-col pointer-events-auto transform transition-all"
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            ...
            <div className="flex flex-col items-center text-center mb-4">
              {profile.avatar_url ? (
                <img 
                  ...
                  className="w-20 h-20 rounded-full object-cover ring-4 ring-indigo-100 mb-3"
                />
              ) : (
                <div className="mb-3">
            ...
            {profile.charity_percentage > 0 && profile.selected_charity && (
              <div className="bg-gradient-to-br from-pink-50 to-red-50 rounded-lg p-3 border border-pink-200 mb-4">
          ...
          {profile.handle && profile.isPublic && (
            <div className="border-t border-gray-200 p-3 bg-gray-50 rounded-b-xl flex-shrink-0">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white text-sm font-bold rounded-lg hover:shadow-lg transition-all duration-300"
              >
