...
function SideMenu({ isOpen, onClose, userInfo, isLoadingProfile, onOpenProfileSettings, onOpenAccountSettings }) {
  ...
  const handleCopyProfileLink = () => {
    const handle = userInfo?.handle || 'your-profile';
  ...
  const accountItems = [
    ...
    { 
      to: userInfo?.handle ? `/u/${userInfo.handle}` : '/u/profile',
