        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/social-impact" className="hover:text-white transition-colors">
                  Social Impact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="mailto:support@mindpick.me" className="hover:text-white transition-colors">
                  Support
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:hello@mindpick.me" className="hover:text-white transition-colors">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a 
                href="https://linkedin.com/company/mindpick" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-9 h-9 bg-gray-800 hover:bg-indigo-600 rounded-lg flex items-center justify-center transition-colors"
                aria-label="LinkedIn"
