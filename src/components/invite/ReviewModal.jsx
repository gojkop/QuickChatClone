      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-surface rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-surface border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-2xl">
            <h2 className="text-xl sm:text-2xl font-bold text-ink">Review Your Invitation</h2>
            <button
              onClick={onClose}
          ...
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 rounded-xl p-5">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex-1">
                  ...
                  <p className="text-xl sm:text-2xl font-bold text-ink">{expertHandle}</p>
                </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                {/* Recording Card - Neutral with orange icon */}
                {hasRecording && (
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                {/* Context Card - Neutral with blue icon */}
                {hasContext ? (
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <div className="flex items-start gap-3">
                ...
                {/* Files Card - Neutral with purple icon */}
                {hasAttachments ? (
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-green-700">
                      ...
                      {' '}ready. Your invitation will be sent instantly.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="border-t-2 border-gray-200 pt-6">
              <h3 className="text-base sm:text-lg font-bold text-ink mb-4">How They'll Receive the Invitation</h3>
              <DeliveryPreview
