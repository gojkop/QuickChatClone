...
function SignInPage() {
  ...
  useEffect(() => {
    // Check if 'force' param is present, which would prevent redirection
        ...
        <div className="bg-white rounded-2xl shadow-lg">
          <div className="p-8 text-center">
            ...
            <button
              ...
              disabled={isLoading}
              className="mt-6 w-full inline-flex items-center justify-center gap-2 rounded-lg bg-indigo-600 text-white font-semibold px-4 py-3 hover:bg-indigo-700 focus:outline-none disabled:opacity-60 disabled:cursor-not-allowed"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24"><path fill="currentColor" d="M21.8 10.23h-9.55v3.54h5.46c-.24 1.37-1.48 4.02-5.46 4.02c-3.29 0-5.98-2.72-5.98-6.08s2.69-6.08 5.98-6.08c1.87 0 3.12.8 3.84 1.49l2.61-2.52C17.31 2.87 15.02 2 12.25 2C6.9 2 2.5 6.42 2.5 11.71S6.9 21.42 12.25 21.42c7.12 0 9.25-4.97 9.25-7.6c0-.51-.05-1-.12-1.59Z" /></svg>
