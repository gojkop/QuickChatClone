...
function SocialImpactPage() {
  ...
  return (
    <div className="bg-slate-50">
      {/* 1. CORRECTED Hero Section with balanced padding */}
      ...
      <section ref={counterRef} className="py-16 md:py-20 text-center">
        ...
        <div className="container mx-auto px-6 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12 mt-12">
                <div className="flex flex-col items-center p-6">
                    <div className="flex items-center justify-center h-20 w-20 rounded-full bg-indigo-100 text-indigo-600 mb-4">
                        <svg className="h-10 w-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                    </div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">1. Expert Chooses Cause</h3>
                ...
                <div className="flex flex-col items-center p-6">
                    <div className="flex items-center justify-center h-20 w-20 rounded-full bg-purple-100 text-purple-600 mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">2. Ask Pays, Funds Split</h3>
                ...
                <div className="flex flex-col items-center p-6">
                    <div className="flex items-center justify-center h-20 w-20 rounded-full bg-green-100 text-green-600 mb-4">
                        <svg className="h-10 w-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0zm-4 0h.01"></path></svg>
                    </div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">3. Direct to Charity</h3>
      ...
      {/* 3. RESTORED Charities Section with all 6 charities */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            />
             <CharityCard 
              ...
              icon={<svg className="h-8 w-8 text-gray-800" fill="currentColor" viewBox="0 0 20 20"><path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path><path fillRule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd"></path></svg>}
            />
            <CharityCard 
              title="GiveDirectly" 
              ...
              icon={<svg className="h-8 w-8 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>}
            />
            <CharityCard 
              title="charity: water" 
              ...
              icon={<svg className="h-8 w-8 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>}
            />
          </div>
        </div>
      </section>
